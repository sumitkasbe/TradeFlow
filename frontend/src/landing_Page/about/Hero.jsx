function Hero() {
    return (
        <div className="container">
            <div className="row">
                <h1 className="text-center mb-5 p-5 mt-5 fs-2 text-muted">We pioneered the discount broking model in India. <br /> Now, we are breaking ground with our technology.</h1>
            </div>

            <div className="row border-top">
                <div className="col-6 mt-5 p-5 text-muted" style={{lineHeight: "1.9", fontSize: "1.2em"}}>
                    <p>
